...
function TransactionCard({ transaction }: TransactionCardProps) {
  ...
  return (
    <div
      className={cn(
        'w-[280px] rounded-lg border bg-card p-3 shadow-md transition-all hover:shadow-lg hover:scale-[1.02]',
...
export function TransactionTimeline({ transactions, className }: TransactionTimelineProps) {
  ...
  return (
    <Card className={className}>
      ...
      <CardContent>
        {/* Desktop view */}
        <div className="hidden md:block relative py-8" style={{ minHeight: `${Math.max(600, sortedTransactions.length * 120)}px` }}>
          {/* Central timeline */}
          <div className="absolute left-1/2 top-8 bottom-8 w-0.5 bg-foreground/20 -translate-x-1/2" />
          ...
          <div className="relative w-full max-w-5xl mx-auto">
            {sortedTransactions.map((transaction, index) => {
              ...
              const topPosition = 40 + index * 120;
                ...
                <div key={transaction.id}>
                  ...
                  <div
                    ...
                    style={{
                      ...
                      [isLeft ? 'right' : 'left']: 'calc(50% + 185px)',
                    }}
                  >
